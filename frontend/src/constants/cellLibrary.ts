...
export const CELL_PRESETS: CellPreset[] = [
  ...
  // ── Bacteria (spherical-shell approximation) ────────────────────────────────
  {
    ...
    label: 'E. coli K-12',
    shortLabel: 'E. coli',
    notes: 'Gram-neg · R ≈ 1 µm · fc in MHz range · model approximation',
    radius: 1,
    membraneThickness: 8,
  ...
  // ── Enveloped viruses (lipid bilayer shell approximation) ───────────────────
  {
    ...
    label: 'Influenza A',
    shortLabel: 'Flu A',
    notes: 'Enveloped RNA virus · R ≈ 65 nm · fc in GHz range',
    radius: 0.065,
  ...
  },
  {
    ...
    label: 'SARS-CoV-2',
    shortLabel: 'CoV-2',
    notes: 'Enveloped RNA virus · R ≈ 60 nm · spike protein envelope',
    radius: 0.060,
    membraneThickness: 10,
    naturalFrequency: 200,
    thresholdVoltage: 0.25,
