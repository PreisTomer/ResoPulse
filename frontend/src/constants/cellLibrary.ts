...
export const CELL_PRESETS: CellPreset[] = [
  ...
  // ── Enveloped viruses (lipid bilayer shell approximation) ───────────────────
  {
    ...
    label: 'Influenza A',
    shortLabel: 'Flu A',
    notes: 'Enveloped RNA virus · R ≈ 100 nm · spherical approx · Schwan fc ~0.45 MHz (σ_i-limited; model approximate for virions)',
    radius: 0.100,
  ...
  },
  {
    ...
    label: 'SARS-CoV-2',
    shortLabel: 'CoV-2',
    notes: 'Enveloped RNA virus · R ≈ 100 nm · spike protein envelope · Schwan fc ~0.36 MHz (σ_i-limited; model approximate for virions)',
    radius: 0.100,
    membraneThickness: 10,
    naturalFrequency: 200,
    thresholdVoltage: 0.25,
