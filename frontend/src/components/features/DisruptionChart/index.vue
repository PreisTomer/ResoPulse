...
import { clearChartContainer, createSvgRoot, measureChartBox, observeChartResize } from '@/utils/chartUtils'
...
export default defineComponent({
  ...
  methods: {
    ...
    initChart() {
      ...
      const { totalW, totalH, chartW, chartH } = measureChartBox(container, MARGIN, 600, 220)
