...
import { buildLogFrequencyPoints, CHART_F_MAX_HZ, CHART_F_MIN_HZ, CHART_N_POINTS, logspace } from '@/utils/chartUtils'
...
export const F_MIN_HZ         = CHART_F_MIN_HZ
export const F_MAX_HZ         = CHART_F_MAX_HZ
export const F_CURSOR_MAX_KHZ = 10_000    // 10 MHz, covers bacteria fc range
export const N_POINTS         = CHART_N_POINTS
export const MARGIN            = { top: 22, right: 130, bottom: 52, left: 54 }

export { logspace }

export const F_POINTS_HZ: number[] = buildLogFrequencyPoints(N_POINTS)
