...
import { SweepChart, SweepControls, SweepKeyPoints, SweepWindowInfo } from './components'
import { buildSweepPoint, isSweepPointInSelectiveWindow, type SweepPoint } from './lib'
...
export default defineComponent({
  ...
  methods: {
    ...
    exportCSV() {
      ...
      downloadText(meta + '\n' + header + '\n' + rows.join('\n'), `sweep_${this.sweepParam}_${Date.now()}.csv`, 'text/csv')
    },
  },
})
</script>
