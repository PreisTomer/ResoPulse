...
import { tipWaveform, tipDutyCycle, tipPulseWidth } from '@/tooltips/sliderTooltips'
import {
...
export default defineComponent({
  ...
  computed: {
    ...
    tipDutyCycle(): string {
      return tipDutyCycle(buildDutyCycleTooltipParams({
    ...
    tipPulseWidth(): string {
      return tipPulseWidth(buildPulseWidthTooltipParams({
    ...
    lysisTimeDisplay(): string { return buildLysisTimeDisplay(this.cellStore.lysisDelayMs) },
