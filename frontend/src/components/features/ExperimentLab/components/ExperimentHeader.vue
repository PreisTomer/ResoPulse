...
export default defineComponent({
  ...
  computed: {
    ...
    tipHealthyBadge(): string {
      return buildExperimentCellBadgeTooltip(tipCellBadgeHealthy, this.cellStore.healthy, this.cellStore.healthyFc)
    },

    tipTargetBadge(): string {
      return buildExperimentCellBadgeTooltip(tipCellBadgeTarget, this.cellStore.target, this.cellStore.targetFc)
    },
