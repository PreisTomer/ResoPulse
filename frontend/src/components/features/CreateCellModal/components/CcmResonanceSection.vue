...
<template>
  <div class="ccm-resonance">
    <div class="ccm-resonance__title">
      ...
      <span class="ccm-resonance__sub">{{
        $t("userPresets.resonanceSectionSub")
      }}</span>
    </div>
  ...
  computed: {
    ...
    fields(): FieldConfig[] {
      return [
        {
          key: "resonantFreqGHz",
          labelKey: "userPresets.fieldResFreq",
          subHintKey: "userPresets.fieldResFreqSub",
          tipKey: "resFreq",
          unit: UNIT.GHZ,
          step: 0.01,
          min: 0.001,
        ...
        {
          key: "capsidQ",
          labelKey: "userPresets.fieldCapsidQ",
          subHintKey: "userPresets.fieldCapsidQSub",
          tipKey: "capsidQ",
          step: 1,
          min: 1,
          max: 100,
        ...
        {
          key: "resonantThresholdVcm",
          labelKey: "userPresets.fieldResThr",
          subHintKey: "userPresets.fieldResThrSub",
          tipKey: "resThr",
          unit: UNIT.V_PER_CM,
          step: 100,
          min: 10,
