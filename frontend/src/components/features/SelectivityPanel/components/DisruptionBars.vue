...
import { isConfiguredResonanceTarget } from '@/utils/cellModel'
import {
  tipTargetPlysis,
  tipHealthyPlysis,
  tipNuclearSection,
...
export default defineComponent({
  ...
  computed: {
    ...
    tipTargetBar(): string {
      return tipTargetBar(buildTargetBarTooltipParams({
        ratio: this.targetRatio,
        vm: this.cellStore.targetVm,
        tempC: this.cellStore.targetTemp,
    ...
    tipHealthyBar(): string {
      return tipHealthyBar(buildHealthyBarTooltipParams({
        ratio: this.healthyRatio,
        vm: this.cellStore.healthyVm,
        tempC: this.cellStore.healthyTemp,
        waveform: this.cellStore.waveform,
        isResonanceTarget: this.isResonanceTarget,
