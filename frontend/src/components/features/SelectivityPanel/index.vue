...
import { effectiveElectroporationThreshold, isConfiguredResonanceTarget } from '@/utils/cellModel'
...
export default defineComponent({
  ...
  computed: {
    ...
    isResonanceTarget(): boolean {
      return isConfiguredResonanceTarget(this.cellStore.target, this.cellStore.targetCellCategory)
    },
    ...
    windowScore(): number {
      return computeWindowScore(this.cellStore.targetLysisProbabilityRandom, this.cellStore.healthyLysisProbabilityRandom)
    },
    ...
    cellSizeParams(): { rT: number; rH: number; vthT: number; vthH: number } {
      return {
        ...
        vthT: effectiveElectroporationThreshold(this.cellStore.target.thresholdVoltage,  this.cellStore.targetTemp, this.cellStore.waveform),
        vthH: effectiveElectroporationThreshold(this.cellStore.healthy.thresholdVoltage, this.cellStore.healthyTemp, this.cellStore.waveform),
      }
    },
