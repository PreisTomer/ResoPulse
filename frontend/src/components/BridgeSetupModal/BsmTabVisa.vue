      ...
      <div class="bsm__step">
        ...
        <div class="bsm__step-content">
          ...
          <div class="bsm__code">
            ...
            <button class="bsm__copy-btn" :class="{ 'bsm__copy-btn--copied': copiedKey === CMD.INSTALL_VISA }" @click="$emit(EMIT.COPY, CMD.INSTALL_VISA)" type="button">
      ...
      <div class="bsm__step">
        ...
        <div class="bsm__step-content">
          ...
          <div class="bsm__code">
            ...
            <button class="bsm__copy-btn" :class="{ 'bsm__copy-btn--copied': copiedKey === CMD.RUN_VISA }" @click="$emit(EMIT.COPY, CMD.RUN_VISA)" type="button">
