...
export const CELL_PRESETS: CellPreset[] = [
  ...
  },
  {
    ...
    sigmaUncertaintyPct: 16,           // Zheng 2013: SD = 0.12 S/m on mean 0.76 S/m → CV = 16%
    density: 1080,
...

  {
    ...
    sigmaUncertaintyPct: 13,           // electrorotation typical run-to-run variance; Lannin 2016 full SD not available
    density: 1080,
    specificHeatCapacity: 3200,
    amplitude: 0.5,
  ...
  },
  {
    ...
    sigmaUncertaintyPct: 18,           // Wang 2017: SD = 0.18 S/m on mean 0.99 S/m → CV = 18%
    density: 1070,
    specificHeatCapacity: 3200,
    amplitude: 0.5,
