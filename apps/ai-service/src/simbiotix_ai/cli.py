...
"""Command-line interface for the SimBiotix AI optimizer service."""
...
def main() -> None:
    """
    SimBiotix AI protocol optimizer.
    ...
    \b
        cd apps/ai-service
        uv sync
        uv run simbiotix-ai seed-demo   # optional — pre-populates training data
        uv run simbiotix-ai serve
    """
...
def serve(host: str, port: int, reload: bool, log_level: str) -> None:
    """
    Start the SimBiotix AI optimizer FastAPI service.
    ...
    \b
      ...
      simbiotix-ai serve --host 0.0.0.0 --port 8000

    \b
      # Development with auto-reload
      simbiotix-ai serve --reload
    """
    import uvicorn

    console.print(
        f"[bold green]SimBiotix AI Service[/bold green] starting on "
...
def seed_demo() -> None:
    ...
    \b
      ...
      simbiotix-ai seed-demo
      simbiotix-ai serve
    """
    import logging
    logging.basicConfig(level=logging.INFO)

    from simbiotix_ai.seed import seed_database
    from simbiotix_ai.train import DATA_DIR, retrain_model
